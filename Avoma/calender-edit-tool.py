...
def getMonthEventDetailsInMapAndCalculateInterviewTimeSpent(service):
...
def timeSpentInMeetingsAndHighestLeastmeetingMonth(months_details):
   max_meeting=0
   max_month=""
   min_month=""
...
def main():
   ...
   months_details = getMonthEventDetailsInMapAndCalculateInterviewTimeSpent(service)
   timeSpentInMeetingsAndHighestLeastmeetingMonth(months_details)
